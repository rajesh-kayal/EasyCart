       ...
       <div class="container">
           <div class="row">
               ...
               <div class="col-6 col-lg-2 mb-3">
                   ...
                   <ul class="list-unstyled mb-md-4 mb-lg-0">
                       ...
                       <li class="lh-lg"><a class="text-800 text-decoration-none" href="#!">How to Track Order</a></li>
                   </ul>
               </div>
               <div class="col-6 col-lg-2 mb-3">
               ...
               <div class="col-sm-6 col-lg-auto ms-auto">
                   <h5 class="lh-lg fw-bold text-1000">Signup For The Latest Update</h5>
                   ...
                   <p class="text-800">
                       ...
                       </svg><span class="text-800">+91 6296155279</span>
                   </p>
                   <p class="text-800">
                       ...
                       </svg><span class="text-800">rajeshkayal@gmail.com</span>
                   </p>
               </div>
           </div>
           ...
           <div class="row flex-center my-3">
               <div class="col-md-6 order-1 order-md-0">
                   <p class="my-2 text-1000 text-center text-md-start">Copyright&nbsp;&copy; <?php echo date('Y') ?> All rights reserved By <a href="#">Rajesh Kayal</a>
                   </p>
               </div>
               <div class="col-md-6">
